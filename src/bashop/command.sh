...
bashop::command::show_help() {
  ...
  if [[ ${no_options} -gt 0 ]]; then
    bashop::logger::echo "Options:"
    bashop::logger::help_formater raw_command_options[@]
  fi
}
